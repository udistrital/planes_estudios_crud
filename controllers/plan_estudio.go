...
// PlanEstudioController operations for PlanEstudio
type PlanEstudioController struct {
	beego.Controller
}

// URLMapping ...
func (c *PlanEstudioController) URLMapping() {
...
// @Param	body		body 	models.PlanEstudio	true		"body for PlanEstudio content"
// @Success 201 {int} models.PlanEstudio
// @Failure 403 body is empty
// @router / [post]
func (c *PlanEstudioController) Post() {
	var v models.PlanEstudio
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {

		v.FechaCreacion = time_bogota.TiempoBogotaFormato()
		v.FechaModificacion = time_bogota.TiempoBogotaFormato()

		if _, err := models.AddPlanEstudio(&v); err == nil {
...
// @Success 200 {object} models.PlanEstudio
// @Failure 403 :id is empty
// @router /:id [get]
func (c *PlanEstudioController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetPlanEstudioById(id)
	if err != nil {
		logs.Error(err)
...
// @Failure 403
// @router / [get]
func (c *PlanEstudioController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllPlanEstudio(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
...
func (c *PlanEstudioController) Put() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		...
		if err := models.UpdatePlanEstudioById(&v); err == nil {
...
// @Failure 403 id is empty
// @router /:id [delete]
func (c *PlanEstudioController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeletePlanEstudio(id); err == nil {
